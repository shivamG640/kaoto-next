...
import { getArrayProperty, NodeIconResolver, NodeIconType, ROOT_PATH, getCustomSchemaFromPipe, updatePipeFromCustomSchema, setValue, getValue } from '../../../utils';
...
export class PipeVisualEntity implements BaseVisualCamelEntity {
  ...
  getComponentSchema(path?: string): VisualComponentSchema | undefined {
    ...
    if (path === ROOT_PATH) {
      return {
        ...
        definition: getCustomSchemaFromPipe(this),
      };
    }
  ...
  updateModel(path: string | undefined, value: Record<string, unknown>): void {
    ...
    if (path === ROOT_PATH) {
      updatePipeFromCustomSchema(this, value);
      return;
    }
