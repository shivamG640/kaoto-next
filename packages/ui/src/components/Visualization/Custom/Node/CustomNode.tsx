...
const CustomNode: FunctionComponent<CustomNodeProps> = observer(
  ({ element, onContextMenu, onCollapseToggle, dndDropRef, canDrop, droppable, hover }) => {
    if (!isNode(element)) {
...
export const CustomNodeWithSelection = withDndDrop(nodeDropTargetSpec)(withContextMenu(NodeContextMenuFn)(CustomNode));
