import { getUserUpdatedPropertiesSchema } from './get-user-updated-properties-schema';
...
describe('getUserUpdatedPropertiesSchema()', () => {
  ...
  it('should return only the properties which are user Modified', () => {
    const processedSchema = getUserUpdatedPropertiesSchema(schema.properties, inputModel, schema);
    expect(processedSchema).toMatchSnapshot();
  });

  it('should return {}', () => {
    const processedSchema = getUserUpdatedPropertiesSchema(schema.properties, {}, schema);
